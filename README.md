...
* 2D Transformations (Translation, Scaling, Rotation, Shearing, Reflection-w.r.t Origin, w.r.t X-axis, with Y-axis, w.r.t X=Y, w.r.t X=-Y)  
* Bezier Curves
* Boundary Filling
* Bresenham Line 
...
* Sutherland Hodgeman Polygon Filling
